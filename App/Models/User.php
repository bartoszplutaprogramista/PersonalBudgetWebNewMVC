...
class User extends \Core\Model
{
    ...
    public function __construct($data)
    {
        ...
        $this->email = $data['email'] ? $data['email'] : '(no email)';
        $this->password = $data['password'] ? $data['password'] : '(no password)';
    } */
...
/*
    ...
    {
       // $url = "http://www.domain.com/register/registration.php?token=stud";
